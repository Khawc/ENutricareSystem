...
<head>
    ...
    <title>NUTRITION : HOME ONE</title>

    <!-- fonts -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:300,300i,400,600,700|Quicksand:300,400,700" rel="stylesheet">

    <!-- themify icon -->
    <link href="${pageContext.request.getContextPath()}/assets/css/themify-icons.css" rel="stylesheet">

    <!-- animate -->
    <link href="${pageContext.request.getContextPath()}/assets/css/animate.css" rel="stylesheet">

    <!-- meanmenu -->
    <link href="${pageContext.request.getContextPath()}/assets/css/meanmenu.min.css" rel="stylesheet">

    <!-- bootstrap -->
    <link href="${pageContext.request.getContextPath()}/assets/css/bootstrap.min.css" rel="stylesheet">

    <!-- carousel -->
    <link href="${pageContext.request.getContextPath()}/assets/css/owl.carousel.min.css" rel="stylesheet">

    <!-- fevicon-->
    <link rel="shortcut icon" type="image/png" href="${pageContext.request.getContextPath()}/assets/images/fevicon.png">

    <!-- style -->
    <link href="${pageContext.request.getContextPath()}/assets/css/style.css" rel="stylesheet">
</head>
<body>
<div class="home1">
    <!-- =================================================
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <div class="header_logo">
                        <a href="index.html">
                            <img src="${pageContext.request.getContextPath()}/assets/images/head-logo.png" alt="logo">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="nav_right">
                        <nav class="mainmenu">
                            <ul>
                                ...
                                <li>
                                    <a href="nutritionist.html">Nutritionist & Dietitian</a>
                                </li>
                                <li>
                        ...
                        <div class="search_bar">
                            ...
                            <form action="#" class="search_hover">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="mobile_mean_logo">
                            <a href="index.html">
                                <img src="${pageContext.request.getContextPath()}/assets/images/head-logo.png" alt="">
                            </a>
                        </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="blog3.html">Blog Three</a>
                                        </li>
                                        <li>
                                            <a href="blog4.html">Blog Four</a>
                                        </li>
                                        <li>
                                            <a href="blog5.html">Blog Five</a>
                                        </li>
                                        <li>
                                            <a href="single-blog.html">Blog Detail</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="nutritionist.html">Nutrotionist</a>
                                        </li>
                                        <li>
                                            <a href="healthy-reciepe.html">Healthy Reciepe</a>
                                        </li>
                                        <li>
        ...
        <div class="banner_slider owl-carousel">
            <div class="single_slider">
                            ...
                            <div class="banner_content">
                                <div class="banner_content_cell">
                                    ...
                                    <a href="" class="animated">
                                        <img src="${pageContext.request.getContextPath()}/assets/images/link-bg.png" alt="link">
                ...
                <div class="banner_bg animated">
                    <img src="${pageContext.request.getContextPath()}/assets/images/banner.jpg" alt="img">
                </div>
            </div>
            <div class="single_slider">
                <div class="container">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="single_need">
                        ...
                        <div class="sn_need_desc">
                            <p>Consectetuer adipiscing elit, sed dia
                    ...
                    <div class="ht_reciepe_slider owl-carousel">
                        <div class="single_reciepe">
                            <div class="sn_reciepe_img">
                                <img src="${pageContext.request.getContextPath()}/assets/images/one.png" alt="reciepe">
                            </div>
                            ...
                            <div class="sn_reciepe_ingredient">
                                <p><span>Ingredients :</span> Tomato, Egg, Cucumber, Chicken,
                                    Carrot, Avocado</p>
                            </div>
                        </div>
                        <div class="single_reciepe">
                            <div class="sn_reciepe_img">
                                <img src="${pageContext.request.getContextPath()}/assets/images/two.png" alt="reciepe">
                            </div>
                            <div class="sn_reciepe_title">
                                <a href="healthy-reciepe.html">
                                    <h3>Fruit Salad</h3>
                        ...
                        <div class="single_reciepe">
                            <div class="sn_reciepe_img">
                                <img src="${pageContext.request.getContextPath()}/assets/images/three.png" alt="reciepe">
                            </div>
                            <div class="sn_reciepe_title">
                                <a href="healthy-reciepe.html">
                                    <h3>Fruit Salad</h3>
                        ...
                        <div class="single_reciepe">
                            <div class="sn_reciepe_img">
                                <img src="${pageContext.request.getContextPath()}/assets/images/four.png" alt="reciepe">
                            </div>
                            <div class="sn_reciepe_title">
                                <a href="healthy-reciepe.html">
                                    <h3>Fruit Salad</h3>
                    ...
                    <div class="calculator_counting">
                        <form class="bmical" action="#" method="post">
                            ...
                            <div class="banner_content_cell">
                                ...
                                <button>
                                    <img src="${pageContext.request.getContextPath()}/assets/images/cal-link-bg.png" alt="link">
                                    <span>calculate</span>
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="nutrotionist_slider owl-carousel">
                        <div class="single_nutrotionist">
                            <div class="nutrotionist_img">
                                <img src="${pageContext.request.getContextPath()}/assets/images/nutrotionist.jpg" alt="">
                            </div>
                            <div class="nutrotionist_detail">
                                <div class="nutritionist_name">
                                    <a href="">
                                        <h3>Ishrat Nawshin</h3>
                                    </a>
                        ...
                        <div class="single_nutrotionist">
                            <div class="nutrotionist_img">
                                <img src="${pageContext.request.getContextPath()}/assets/images/nutrotionist-two.jpg" alt="">
                            </div>
                            <div class="nutrotionist_detail">
                                <div class="nutritionist_name">
                                    <a href="">
                ...
                <div class="col-lg-4 col-sm-4 col-md-4">
                    <div class="contact_no">
                        <a href="">
                            ...
                            <span>(+880) 1111 2222 3333</span>
                        </a>
                        <a href="">
                            <span class="ti-email"></span>
                            <span>nutrition@gmail.com</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-8 col-sm-8 col-md-8">
                    <div class="subscribe_section">
                        ...
                        <div class="subscribe_btn">
                            <a href="" class="btn_one">Free consultation</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row single_weightloss">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 img">
                            <div class="wtloss_img">
                                <img src="${pageContext.request.getContextPath()}/assets/images/wtloss-one.jpg" alt="wtl-one">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content">
                            <div class="wtloss_content">
                                <div class="wtloss_title">
                                    <a href="">
                                        <h2>Seminar on healthy food</h2>
                                    </a>
                                </div>
                                <div class="wtloss_meta">
                                    <a href=""><span class="ti-calendar"></span>22/05/2017</a>
                                    <a href=""><span class="ti-user"></span>Ishrat Nawshin</a>
                                </div>
                                <div class="wtloss_desc">
                                    <p>Nutrition tis nisl ut aliquip ex ea commodo consequat. Duis autem vell
                                        eum iriure dolor in hendrerit in vulputate velit esse molestie consequat
                                        vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et ius
                                        to odio dignissim...</p>
                                </div>
                    ...
                    <div class="row single_weightloss">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 img">
                            <div class="wtloss_img">
                                <img src="${pageContext.request.getContextPath()}/assets/images/wtloss-two.jpg" alt="wtl-one">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content">
                            <div class="wtloss_content">
    ...
    <footer class="footer_area">
        ...
        <div class="footer_bottom_area">
            <p>All copyright © reserved by <a href="#!">ThemeeBiT</a> 2017</p>
        </div>
    </footer>
    <!-- =================================================
                9. End Footer Area
...
<!-- jquery -->
<script src="${pageContext.request.getContextPath()}/assets/js/jquery-3.2.1.min.js"></script>

<!-- bootstrap -->
<script src="${pageContext.request.getContextPath()}/assets/js/bootstrap.min.js"></script>

<!-- bootstrap -->
<script src="${pageContext.request.getContextPath()}/assets/js/jquery.meanmenu.min.js"></script>

<!-- bootstrap -->
<script src="${pageContext.request.getContextPath()}/assets/js/owl.carousel.min.js"></script>

<!--  Google map api  -->
<script src="https://maps.googleapis.com/maps/api/js"></script>

<!-- main -->
<script src="${pageContext.request.getContextPath()}/assets/js/main.js"></script>
</body>
</html>
